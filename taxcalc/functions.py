...
def ItemDed_calc(_posagi, e17500, e18400, e18425, e18450, e18500, e18800, e18900,
    ...
    return (c17750, c17000, _sit1, _sit, _statax, c18300, float(c37703), float(c20500),
            c20750, float(c20400), float(c19200), c20800, c19700, c21060, float(_phase2_i),
...
def ItemDed_apply(_posagi, e17500, e18400, e18425, e18450, e18500, e18800, e18900,
    ...
    for i in range(len(_posagi)):
        ...
        _nonlimited[i], _limitratio[i], c04470[i], c21040[i]
            ...
            MARS[i], _sep[i], c00100[i], puf, phase2, _phase2_i[i])
...
@jit(nopython=True)
def StdDed_calc( DSI, _earned, stded, e04470, e02400, puf,
    ...
    #should be this? doesnt seem to affect accuracy
    ...
    if puf:
        if FDED == 2 and e04470 > stded[MARS - 1]:
            if MARS != 2:
                ...
                _numextra = e04470 - (stded[MARS - 1]/float(aged[2]))
        elif e02400 > 0:
...
def StdDed_apply(c15100, _numextra, _txpyers, c15200,
                _othded, c04100, c04200, _standard, c04500,
                 ...
                 _earned, stded, e04470, e02400, puf,
    ...
    for i in range(len(c15100)):
        ...
        c04800[i], c60000[i], _amtstd[i], _taxinc[i], _feitax[i], _oldfei[i]
            ...
            DSI[i], _earned[i], stded, e04470[i], c04470[i], e02400[i],
            MARS[i], MIdR[i], e15360[i], AGEP[i], AGES[i], PBI[i], SBI[i], 
            _exact[i], e04200[i], aged, puf, c00100[i], c21060[i],
        ...
        (pf.c15100, pf._numextra, pf._txpyers, pf.c15200,
         ...
         pf.c04800, pf.c60000, pf._amtstd, pf._taxinc, pf._feitax, pf._oldfei) = \
            StdDed_apply(
                ...
                pf._earned, pm.stded, pf.e04470, pf.e02400, puf,
...
def RateRed_calc(c05800, _fixup, _othtax, _exact, x59560, _earned, e59560):
    ...
    return c07970, c05800, float(c59560)
    ...
    outputs = \
        pf.c07970, pf.c05800, pf.c59560 = \
            RateRed_apply(
                ...
                pf._exact, pf.x59560, pf._earned, pf.e59560 )
